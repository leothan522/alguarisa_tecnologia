            ...
            <div class="card card-outline card-navy">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div wire:ignore>
                            <div class="input-group mb-3" id="div_select_bienes_tipo_modal">
                    ...
                    <div class="form-group">
                        ...
                        <div wire:ignore>
                            <div class="input-group mb-3" id="div_select_bienes_marca_modal">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-bookmark"></i></span>
                                </div>
                                <select class="custom-select">
                    ...
                    <div class="form-group">
                        ...
                        <div wire:ignore>
                            <div class="input-group mb-3" id="div_select_bienes_modelo_modal">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-bookmark"></i></span>
                                </div>
                                <select class="custom-select">
                    ...
                    <div class="form-group">
                        ...
                        <div wire:ignore>
                            <div class="input-group mb-3" id="div_select_bienes_color_modal">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-bookmark"></i></span>
                                </div>
                                <select class="custom-select">
            ...
            <div class="card card-outline card-navy">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div wire:ignore>
                            <div class="input-group mb-3" id="div_select_bienes_condicion_modal">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-bookmark"></i></span>
                                </div>
                                <select class="custom-select">
