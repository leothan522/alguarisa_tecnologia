    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <button type="button" class="btn btn-tool" wire:click="create"
                    @if(!comprobarPermisos('ubicaciones.create')) disabled @endif>
                <i class="fas fa-file"></i> Nuevo
            </button>
            <button type="button" class="btn btn-tool" wire:click="setLimit"
                    @if(($rows > $rowsUbicaciones) || ($keyword && $rows > $totalBusqueda)) disabled @endif >
                ...
                @foreach($listarUbicaciones as $ubicacion)
                    <tr>
                        ...
                        <td class="justify-content-end">
                            <div class="btn-group">
                                <button wire:click="edit('{{ $ubicacion->rowquid }}')" class="btn btn-primary btn-sm"
                                        @if(!comprobarPermisos('ubicaciones.edit')) disabled @endif >
                                    <i class="fas fa-edit"></i>
                                </button>

                                <button wire:click="destroy('{{ $ubicacion->rowquid }}')" class="btn btn-primary btn-sm"
