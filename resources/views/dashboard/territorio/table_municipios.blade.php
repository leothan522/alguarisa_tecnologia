    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <button type="button" class="btn btn-tool" wire:click="setLimit"
                    @if($rows >= $rowsMunicipios) disabled @endif >
                <i class="fas fa-sort-amount-down-alt"></i> Ver más
            </button>
        </div>
    </div>
    <div class="card-body table-responsive p-0" @if($totalMunicipios >= $numero) style="height: 67vh;" @endif >
                ...
                @foreach($listarMunicipios as $municipio)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-success btn-sm" wire:click="filtrarParroquias('{{ $municipio->rowquid }}')">
                        ...
                        <td class="justify-content-end">
                            <div class="d-none d-md-block">
                                <div class="btn-group">
                                    <button wire:click="estatusMunicipio('{{ $municipio->rowquid }}')" class="btn btn-primary btn-sm">
                                    ...
                                    <button wire:click="editMunicipio('{{ $municipio->rowquid }}')"
                                            class="btn btn-primary btn-sm" data-toggle="modal"
                                            data-target="#modal-municipios"
                                            @if(!comprobarPermisos('municipios.edit')) disabled @endif >
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button wire:click="destroyMunicipio('{{ $municipio->rowquid }}')" class="btn btn-primary btn-sm"
                            ...
                            <div class="d-md-none">
                                <button class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#modal-show-municipio"
                                        wire:click="editMunicipio('{{ $municipio->rowquid }}')">
