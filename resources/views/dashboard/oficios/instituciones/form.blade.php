<div class="card card-navy card-outline">
    ...
    <div class="card-body" wire:loading.class="invisible" wire:target="create, cancel, save, buscar" style="max-height: calc(100vh - {{ $size }}px)">
        ...
        <form wire:submit="save">
            ...
            <div class="form-group">
                <small class="text-lightblue text-bold text-uppercase">Sufijo:</small>
                <div class="input-group">
                    <input type="text" wire:model="sufijo" class="form-control @error('sufijo') is-invalid @enderror" placeholder="Sufijo [Opcional]">
                    @error('sufijo')
                    <span class="error invalid-feedback text-bold">{{ $message }}</span>
                    @enderror
                </div>
